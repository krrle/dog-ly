...
var savlangdva = document.querySelector(".name.savlang");
...
link.forEach(element => {
    ...
    element.addEventListener('click', ()=>{
        ...
        savlangdva.textContent = data[att].savlangdva;
        ...
        addlangdva.textContent = data[att].addlangdva;
        objlangdva.textContent = data[att].objlangdva;
